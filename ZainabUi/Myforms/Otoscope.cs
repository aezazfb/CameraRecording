...
{
    public partial class Otoscope : Form
    {
        ...
        private void guna2CircleButton2_Click(object sender, EventArgs e)
        {
            ...
            {
                recording = false;
                guna2CircleButton1.BackgroundImage = global::ZainabUi.Properties.Resources.record;
        ...
        private void guna2CircleButton1_Click(object sender, EventArgs e)
        {
            ...
            {
                recording = true;
                guna2CircleButton1.BackgroundImage = global::ZainabUi.Properties.Resources.recording1;
        ...
        private void Otoscope_Load(object sender, EventArgs e)
        {
        ...
        {
            zoom.ContinouesMove(ZoomDirection.Up, 5);
        }

        private void guna2Button5_Click(object sender, EventArgs e)
        {
            zoom.ContinouesMove(ZoomDirection.Bottom, 5);
        }

        private void guna2Button7_Click(object sender, EventArgs e)
        {
            zoom.ContinouesMove(ZoomDirection.Left, 5);
        }

        private void guna2Button8_Click(object sender, EventArgs e)
        {
            zoom.ContinouesMove(ZoomDirection.Right, 5);
        }
